...
TASK_METHOD_QUALITY = "methodological_quality"
TASK_REPORT = "report"
TASK_VISUAL_INTERPRETATION = "visual_interpretation"
...
TASK_MODEL_ENV = {
    ...
    TASK_METHOD_QUALITY: "AI_METHOD_QUALITY_MODEL",
    TASK_REPORT: "AI_REPORT_MODEL",
    TASK_VISUAL_INTERPRETATION: "AI_VISUAL_INTERPRETATION_MODEL",
}
TASK_TEMPERATURE_ENV = {
    ...
    TASK_METHOD_QUALITY: "AI_METHOD_QUALITY_TEMPERATURE",
    TASK_REPORT: "AI_REPORT_TEMPERATURE",
    TASK_VISUAL_INTERPRETATION: "AI_VISUAL_INTERPRETATION_TEMPERATURE",
}
TASK_DEFAULT_TEMPERATURE = {
    ...
    TASK_EVALUATION: 0.0,
    TASK_EXTRACTION: 0.0,
    TASK_METHOD_QUALITY: 0.0,
    TASK_REPORT: 0.2,
    TASK_VISUAL_INTERPRETATION: 0.0,
}
