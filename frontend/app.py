...
pages = [
    ...
    st.Page(
        "pages/0_Configuracao_Pesquisa.py",
        title="Configuração da Pesquisa",
        icon="⚙️",
    ),
    st.Page("pages/1_Triagem.py", title="Triagem", icon="🧑‍⚕️"),
    st.Page(
        "pages/2_Matriz_Evidencias.py",
        title="Matriz de Evidências",
        icon="📊",
    ),
    st.Page(
        "pages/3_Relatorio_Final.py",
    ...
    st.Page("pages/5_Gestao_PDFs.py", title="Gestão de PDFs", icon="📂"),
    st.Page(
        "pages/6_Fontes_Bibliograficas.py",
        title="Fontes Bibliográficas",
        icon="🌐",
    ),
    st.Page("pages/7_Deduplicacao.py", title="Deduplicação", icon="🔎"),
    st.Page(
        "pages/8_Avaliacao_Quantitativa_RAG.py",
